...
public class TeacherActivity extends AppCompatActivity implements PDFUtility.OnDocumentClose{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            if (token != null && !token.equals(""))
                dRef.child("DeviceTokens").child("Teachers").
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists())
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        String MyID = new BaseUtil(TeacherActivity.this).getID();
                        String MyRole = new BaseUtil(TeacherActivity.this).getLoginRole();
                        String mDepartment = new BaseUtil(TeacherActivity.this).getDepartment();
                ...
                {
                    try {
                        PDFUtility.createPdf(getApplicationContext(), TeacherActivity.this, path, true,list);
                    } catch (Exception e) {
                        Toast.makeText(TeacherActivity.this, "Error Creating Pdf", Toast.LENGTH_SHORT).show();
                    }
                    showPdfSuccessDialog();
                }
                else
                {
                    new SweetAlertDialog(TeacherActivity.this).setTitleText("EMPTY").setContentText("Timetable not added by The Admin for You").setConfirmButton("OK", new SweetAlertDialog.OnSweetClickListener() {
                        @Override
        ...
        sharepdfbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(TeacherActivity.this, "App Not installed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        viewbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(TeacherActivity.this, "No Pdf Viewer install", Toast.LENGTH_SHORT).show();
                }
            }
        });
        alertDialog.show();
